    ...
    <script type="text/javascript">
        ...
        :
            ...
            $(".auditClass").click(function () {
                ...
                if (json.image_front) {
                    form.find("[name=image_front]").attr("src", "http://localhost:8080" + json.image_front);
                }
                if (json.image_behind) {
                    form.find("[name=image_behind]").attr("src", "http://localhost:8080" + json.image_behind);
                }
                $("#myModal").modal("show");
            })
        ...
        <div class="col-sm-9">
            ...
            <form id="searchForm" class="form-inline" method="post" action="/realAuth.do">
                ...
                <div class="form-group">
                    ...
                    <script type="text/javascript">
                        $("[name=state] option[value='${(qo.state)!''}']").attr("selected", true);
                    </script>
                </div>
                <div class="form-group">
                    <label>申请时间</label>
                    <input class="form-control" type="text" name="beginTime" id="beginDate"
                           value="${(qo.beginTime?string('yyyy-MM-dd'))!''}"/>到
                    <input class="form-control" type="text" name="endTime" id="endDate"
                            ...
                            <td>
									<#if (info.state == 0)>
                                        <a href="javascript:void(-1);" class="auditClass"
                                           data-json='${info.getJsonString()}'>审核</a>
                                    </#if>
                            </td>
                        </tr>
                        </#list>
                    ...
                    <form class="form-horizontal" id="editform" method="post" action="/realAuth_audit.do">
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <img src="" name="image_front" style="width: 150px;"/>
                                </div>
                                <label class="col-sm-2 control-label" for="name">身份证背面</label>
                                <div class="col-sm-4">
                                    <img src="" name="image_behind" style="width: 150px;"/>
                                </div>
                            </div>
                            <div class="form-group">
