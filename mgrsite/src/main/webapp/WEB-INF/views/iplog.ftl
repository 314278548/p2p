        ...
        <div class="col-sm-9">
            ...
            <form id="searchForm" class="form-inline" method="post" action="/iplog.do">
                ...
                <div class="form-group">
                    ...
                    <script type="text/javascript">
                        $("[name=userType] option[value=${(qo.userType)!-1}]").attr("selected", "selected");
                    </script>
                </div>
                <div class="form-group">
                    <label>登录时间</label>
                    <input class="form-control beginDate" type="text" name="beginTime"
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>${item.ip}</td>
                            <td>${item.userTypeOfVeiw}</td>
                            <td>${item.stateByView}</td>
                        </tr>
                        </#list>
                    </tbody>
                </table>
