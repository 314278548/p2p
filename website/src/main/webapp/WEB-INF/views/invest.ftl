...
<div class="container" style="min-height: 500px;">
    ...
    <form action="/invest_list.do" id="searchForm" type="post">
        <input type="hidden" name="currentPage" id="currentPage" value="1">
        <div style="margin: 20px 0px;">
            <span class="text-muted">标的状态</span>
            <div style="margin-left: 30px" class="btn-group" data-toggle="buttons">
                <label class="btn btn-default active">
                    <input type="radio" name="state" value="" autocomplete="off" checked/>&emsp;全部&emsp;
                </label>
                <label class="btn btn-default">
                    <input type="radio" name="state" value="1" autocomplete="off"/>&emsp;招标中&emsp;
                </label>
                <label class="btn btn-default">
