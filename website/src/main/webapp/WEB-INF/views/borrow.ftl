			...
			<div class="el-borrow-item col-sm-4">
				...
				<div class="el-borrow-item-content">
					...
					<ul>
						...
						<li>
							<#if !userinfo.isGreaterThanBaseScore()>
								<a href="/userFile.do">材料认证分数为${userinfo.score}分,未满${userinfo.baseScore}</a>
								<span class="glyphicon glyphicon-remove" style="color:red;"></span>
							<#else>材料认证分数达到${userinfo.baseScore}分<span class="glyphicon glyphicon-ok" style="color:green;"></span></#if>
						</li>
						<li>视频认证
							<#if !(userinfo.isBindVedioAuth())><span class="glyphicon glyphicon-remove" style="color:red;"></span>
							<#else><span class="glyphicon glyphicon-ok" style="color:green;"></span></#if>
						</li>
					</ul>
					<#if userinfo.isBindInfo() && userinfo.isBindAuth() && userinfo.isGreaterThanBaseScore() && userinfo.isBindVedioAuth()>
						<a href="/apply.do" class="el-borrow-apply">
							申请贷款
						</a>
					<#else>
